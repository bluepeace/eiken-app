...
sub init {
	...
	$self->{tmpls} = {
		...
		'mpg9015' => "企業用お問い合わせ通知メール（管理者宛）",
		'mpg9016' => "企業用お問い合わせ通知メール（$self->{conf}->{member_caption}宛）",
		...
		'z11toeic500' => "購入者向けご案内「TOEIC500」（$self->{conf}->{member_caption}宛）",
		'z12toeic500' => "管理者向けご案内「TOEIC500」（管理者宛）",
		'z13toeic730' => "購入者向けご案内「TOEIC730」（$self->{conf}->{member_caption}宛）",
		'z14toeic730' => "管理者向けご案内「TOEIC730」（管理者宛）",
		'z21eikenj1'  => "購入者向けご案内「英検準1級」（$self->{conf}->{member_caption}宛）",
		'z22eikenj1'  => "管理者向けご案内「英検準1級」（管理者宛）",
		'z23eiken2'   => "購入者向けご案内「英検2級」（$self->{conf}->{member_caption}宛）",
		'z24eiken2'   => "管理者向けご案内「英検2級」（管理者宛）",
		'dmg9001' => "$self->{conf}->{member_caption}ダイレクトメッセージ送信通知（$self->{conf}->{member_caption}宛）",
		'dmg9002' => "$self->{conf}->{member_caption}ダイレクトメッセージ送信通知（$self->{conf}->{prof_caption}宛）",
		'dmg9011' => "$self->{conf}->{prof_caption}ダイレクトメッセージ送信通知（$self->{conf}->{member_caption}宛）",
		'dmg9012' => "$self->{conf}->{prof_caption}ダイレクトメッセージ送信通知（$self->{conf}->{prof_caption}宛）"
	};
}
