package FCC::Action::Admin::PrfschfrmAction;
$VERSION = 1.00;
use strict;
use warnings;
...
#			}
	...
	unless($available eq "0") {
		$available = "1";
	}
	#my $available = "1";

	#タイムテーブル
	my $interval = 1200; # seconds
	my $time_list = [];
	my $sch_time_hash = {};
...
#		}
	...
	push(@base_url_params, "member_id=${member_id}");
